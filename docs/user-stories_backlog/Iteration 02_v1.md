...
###### Akzeptanzkriterium
- Alle Kernfunktionen von `grdstream` können aus Python ausgeführt werden & es gibt Unit-Tests, die den reibungslosen Aufruf auf UNIX Architekturen gewährleisten.
...
- ...
---
#### (1.2.2) Python-Aufruf der `grdstream` C-Bibliothek in Windows
###### Beschreibung
- Es wird eine Möglichkeit geschaffen, die Funktionen der `grdstream`-C-Bibliothek aus Python auf einem Windows-System aufzurufen.
###### Akzeptanzkriterium
- Alle Kernfunktionen von `grdstream` können aus Python ausgeführt werden & es gibt Unit-Tests, die den reibungslosen Aufruf auf Windows gewährleisten.
